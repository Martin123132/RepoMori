...
class RepoMoriCodecTests(unittest.TestCase):
    ...
    def test_workflow_contracts_for_release_candidate(self) -> None:
        ...
        release_notes = (repo_root / "docs/releases/0.2.1.md").read_text(encoding="utf-8")
        readme = (repo_root / "README.md").read_text(encoding="utf-8")

        self.assertIn('version = "0.2.1"', pyproject)
        self.assertIn("## 0.2.1 - 2026-07-01", changelog)
        ...
        self.assertIn("default: 0.2.1", workflow)
        self.assertIn("# RepoMori 0.2.1", release_notes)
        self.assertIn("Status: final release notes prepared.", release_notes)
        self.assertIn("Release record: [`v0.2.1`", readme)
    ...
    def test_first_tester_path_documents_license_storage_and_core_flow(self) -> None:
        ...
        tester_feedback = (repo_root / "docs" / "tester-feedback.md").read_text(encoding="utf-8")
        pyproject = (repo_root / "pyproject.toml").read_text(encoding="utf-8")

        self.assertIn("docs/first-tester.md", readme)
        self.assertIn("docs/tester-feedback.md", readme)
        ...
        self.assertIn("tester-feedback.md", release_candidate)
        ...
        self.assertIn("tester-feedback.md", first_tester)
        ...
        self.assertIn("contact the COO of TWO HANDS NETWORK LTD", first_tester)
        self.assertIn("source-available software", tester_feedback)
        self.assertIn("personal and non-commercial testing", tester_feedback)
        self.assertIn("contact the COO of TWO HANDS NETWORK LTD", tester_feedback)
        self.assertIn("D:\\Dev\\.repomori-first-test", tester_feedback)
        self.assertIn("release-rehearsal", tester_feedback)
        self.assertIn("reviewer artifact privacy status", tester_feedback)
        self.assertIn("Do Not Send", tester_feedback)
        self.assertIn("Secrets, credentials, API keys", tester_feedback)
        self.assertIn("Commercial-use assumptions", tester_feedback)
