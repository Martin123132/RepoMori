...
RepoMori welcomes ideas, bug reports, and patches that fit the project's local-first, dependency-light direction.
...
If you do not agree to these terms, please open an issue describing the idea instead of submitting code.
