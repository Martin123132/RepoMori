...
def format_release_review_checklist_markdown(
    ...
    lines.extend(
        [
            "",
            "## Privacy Guard Demo Preflight",
            "",
            "Run the synthetic privacy-guard dry-runs before approving or uploading a candidate bundle:",
            "",
            "```powershell",
            ...
            "```",
            "",
            "- Clean expectation: top-level `status` is `pass`, embedded `privacy_guard.status` is `pass`, and `issue_counts_by_code` is empty.",
    ...
    lines.extend(
        [
            ...
            "- [ ] Privacy-guard demo clean/fail expectations were run and reviewed before candidate upload.",
...
def format_release_candidate_artifact_index_markdown(
    ...
    artifacts = [
        ...
        ("release-artifact-index.md", "This first-stop reviewer artifact map.", "generated"),
    ...
    lines = [
        ...
        "## Generation Order",
        "",
        "1. Policy verification writes `release-verify-policy.json` and `.md`.",
        "2. Reviewer checklist and artifact index are generated from policy and evidence.",
